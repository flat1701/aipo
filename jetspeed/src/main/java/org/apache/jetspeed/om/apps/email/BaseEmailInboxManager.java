...
/**
 * This class manages EmailInbox objects.
 ...
 * extended all references should be to EmailInboxManager
 */
public abstract class BaseEmailInboxManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.apache.jetspeed.om.apps.email.EmailInbox";
     ...
     * @exception TorqueException if an error occurs
     */
    public static EmailInbox getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static EmailInbox getInstance(int id)
        throws TorqueException
    {
    ...
    public static boolean exists(EmailInbox obj)
        throws TorqueException
    {
     ...
     */
    protected EmailInbox getInstanceImpl()
        throws TorqueException
    {
        EmailInbox obj = null;
        try
     ...
     */
    protected EmailInbox getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id <code>ObjectKey</code> value
     * @param fromCache if true, look for cached EmailInboxs before loading
     * from storage.
     */
