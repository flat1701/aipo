...
/**
 * This class manages JetspeedRoleProfile objects.
 ...
 * extended all references should be to JetspeedRoleProfileManager
 */
public abstract class BaseJetspeedRoleProfileManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.apache.jetspeed.om.dbpsml.JetspeedRoleProfile";
     ...
     */
    public static JetspeedRoleProfile getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static JetspeedRoleProfile getInstance(int id)
        throws TorqueException
    {
    ...
    public static boolean exists(JetspeedRoleProfile obj)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public BaseJetspeedRoleProfileManager()
        throws TorqueException
    {
     ...
     */
    protected JetspeedRoleProfile getInstanceImpl()
        throws TorqueException
    {
     ...
     *
     * @param id <code>ObjectKey</code> value
     * @param fromCache if true, look for cached JetspeedRoleProfiles before loading
     * from storage.
     */
