...
/**
 * This class manages Coffees objects.
 ...
 * extended all references should be to CoffeesManager
 */
public abstract class BaseCoffeesManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.apache.jetspeed.om.apps.coffees.Coffees";
     ...
     * @exception TorqueException if an error occurs
     */
    public static Coffees getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Coffees getInstance(int id)
        throws TorqueException
    {
    ...
    public static boolean exists(Coffees obj)
        throws TorqueException
    {
     ...
     */
    protected Coffees getInstanceImpl()
        throws TorqueException
    {
        Coffees obj = null;
        try
     ...
     */
    protected Coffees getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Coffeess before loading
     * from storage.
     */
