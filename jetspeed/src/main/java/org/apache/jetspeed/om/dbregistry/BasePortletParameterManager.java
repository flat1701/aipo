 ...
 * extended all references should be to PortletParameterManager
 */
public abstract class BasePortletParameterManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.apache.jetspeed.om.dbregistry.PortletParameter";
     ...
     */
    public static PortletParameter getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static PortletParameter getInstance(long id)
        throws TorqueException
    {
    ...
    public static boolean exists(PortletParameter obj)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public BasePortletParameterManager()
        throws TorqueException
    {
     ...
     */
    protected PortletParameter getInstanceImpl()
        throws TorqueException
    {
     ...
     *
     * @param id <code>ObjectKey</code> value
     * @param fromCache if true, look for cached PortletParameters before loading
     * from storage.
     */
