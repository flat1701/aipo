 ...
 *
 */
public abstract class BasePortletDbEntryPeer
    extends BasePeer
{
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PortletDbEntry> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static PortletDbEntry row2Object(Record row,
                                             int offset,
                                             Class<?> cls)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PortletDbEntry> doSelect(Criteria criteria) throws TorqueException
    {
    ...
    public static List<PortletDbEntry> populateObjects(List<?> records)
        throws TorqueException
    {
        List<PortletDbEntry> results = new ArrayList<PortletDbEntry>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(PortletDbEntryPeer.row2Object(row, 1,
                PortletDbEntryPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<PortletDbEntry> doSelect(PortletDbEntry obj) throws TorqueException
    {
     ...
     */
    public static PortletDbEntry retrieveByPK(long pk)
