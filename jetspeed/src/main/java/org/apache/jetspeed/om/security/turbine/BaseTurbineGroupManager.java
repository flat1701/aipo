 ...
 */
public abstract class BaseTurbineGroupManager
    extends AbstractBaseManager
{
     ...
     */
    public static TurbineGroup getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static TurbineGroup getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static TurbineGroup getInstance(int id)
        throws TorqueException
    {
    ...
    public static boolean exists(TurbineGroup obj)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public BaseTurbineGroupManager()
        throws TorqueException
    {
     ...
     */
    protected TurbineGroup getInstanceImpl()
        throws TorqueException
    {
     ...
     */
    protected TurbineGroup getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
